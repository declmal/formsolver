...
$$
g_{i} = G(r,r_{i}) \ G(s,s_{i}) \ G(t,t_{i})
$$

$$
G({\beta,\beta_{i}}) = \frac{1}{2}(1+\beta_{i}\beta), \ \beta_{i} = \pm 1
$$

$$
G({\beta,\beta_{i}}) = (1-\beta^{2}), \ \beta_{i} = 0
$$
...
$$
h_{10} = 1 - s^{2}, \ h_{11} = 1 - t^{2}, \ h_{9} = 1-r^{2}
$$

$$
{}_{0}h_{n,j}(r_{0},r_{1},r_{2}) = h_{n,o}(r_{1},r_{2},r_{3}) \ {}^{0}J_{oj}^{-1}(0,0,0), (n=9,10,11)
$$
